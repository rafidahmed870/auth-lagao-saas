  ...
  return (
    <section id="footerHero" className="relative py-32 overflow-hidden mt-20">
      ...
      <div className="container mx-auto px-6 relative z-10 flex flex-col items-center text-center">
        ...
        {/* CTA Button */}
        <button onClick={()=> navigate('/register')} className="mt-10 inline-flex items-center gap-3 px-10 py-4 rounded-full bg-white text-black font-semibold text-sm tracking-wide hover:bg-white/90 transition-all duration-300 cursor-pointer shadow-lg shadow-white/10">
          GET STARTED NOW
